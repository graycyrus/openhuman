...
const messages: TranslationMap = {
  ...
  'settings.agentAccess.autoApproveAll.desc':
    'Jika diaktifkan, agen akan menjalankan semua tindakan tanpa meminta persetujuan Anda terlebih dahulu. Ini termasuk penulisan file, perintah shell, permintaan jaringan, dan efek samping lainnya. Batasan keamanan ketat (direktori kredensial, jalur internal ruang kerja) tetap berlaku.',
