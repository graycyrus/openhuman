...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Pendamping Browser',
  'settings.browserCompanion.menuDesc': 'Pasangkan ekstensi Chrome untuk membagikan tab dengan agen Anda melalui relay lokal',
  'settings.browserCompanion.loading': 'Memuat status Pendamping Browser...',
  'settings.browserCompanion.loadError': 'Gagal memuat status Pendamping Browser',
  'settings.browserCompanion.saveError': 'Gagal menyimpan pengaturan Pendamping Browser',
  'settings.browserCompanion.saving': 'Menyimpan...',
  'settings.browserCompanion.statusTitle': 'Status',
  'settings.browserCompanion.relayStatusLabel': 'Relay',
  'settings.browserCompanion.extensionStatusLabel': 'Ekstensi',
  'settings.browserCompanion.running': 'Berjalan',
  'settings.browserCompanion.stopped': 'Berhenti',
  'settings.browserCompanion.extensionConnected': 'Terhubung',
  'settings.browserCompanion.extensionDisconnected': 'Tidak terhubung',
  'settings.browserCompanion.enableLabel': 'Aktifkan Pendamping Browser',
  'settings.browserCompanion.enableDesc': 'Mulai relay lokal agar ekstensi Chrome yang dipasangkan dapat membagikan tab dengan agen Anda',
  'settings.browserCompanion.pairingTitle': 'Pemasangan',
  'settings.browserCompanion.pairingDesc': 'Hubungkan ekstensi Chrome menggunakan URL relay dan token pemasangan',
  'settings.browserCompanion.relayUrl': 'URL relay',
  'settings.browserCompanion.copy': 'Salin',
  'settings.browserCompanion.copied': 'Disalin!',
  'settings.browserCompanion.pairingSecret': 'Token pemasangan',
  'settings.browserCompanion.pairingSecretNone': 'Pasangkan atau putar ulang secret untuk menampilkan token',
  'settings.browserCompanion.extensionIdLabel': 'ID ekstensi',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID ekstensi Chrome',
  'settings.browserCompanion.pairButton': 'Pasangkan',
  'settings.browserCompanion.pairError': 'Gagal memasangkan ekstensi',
  'settings.browserCompanion.rotateError': 'Gagal memutar ulang secret pemasangan',
  'settings.browserCompanion.unpairError': 'Gagal melepas pasangan ekstensi',
  'settings.browserCompanion.installExtension': 'Pasang ekstensi',
  'settings.browserCompanion.installError': 'Gagal membuka folder ekstensi',
  'settings.browserCompanion.openChromeExtensions': 'Buka chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'Memasang ekstensi hanya tersedia di desktop',
  'settings.browserCompanion.sharedTabsTitle': 'Tab yang dibagikan',
  'settings.browserCompanion.sharedTabsDesc': 'Tab yang telah dibagikan oleh ekstensi yang dipasangkan dengan agen Anda',
  'settings.browserCompanion.noSharedTabs': 'Belum ada tab yang dibagikan',
  'settings.browserCompanion.dangerZoneTitle': 'Zona berbahaya',
  'settings.browserCompanion.rotateSecret': 'Putar ulang secret',
  'settings.browserCompanion.rotateConfirm': 'Putar ulang secret pemasangan? Ekstensi perlu dipasangkan ulang dengan token baru.',
  'settings.browserCompanion.unpair': 'Lepas pasangan',
  'settings.browserCompanion.unpairConfirm': 'Lepas pasangan ekstensi? Anda perlu memasangkannya lagi untuk menyambungkan ulang.',
