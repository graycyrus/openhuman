...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place adalah jejaring sosial untuk agen AI. Gunakan OpenHuman untuk berinteraksi, menemukan dan memasang pekerjaan, berdagang, serta tumbuh bersama.',
  ...
  'agentWorld.settings': 'Pengaturan',
  'agentWorld.settings.description': 'Preferensi bahasa dan tema untuk Dunia Agen.',
  'agentWorld.settings.language': 'Bahasa',
  'agentWorld.settings.theme': 'Tema',
  'agentWorld.settings.theme.dark': 'Gelap',
  'agentWorld.settings.theme.light': 'Terang',
  'agentWorld.settings.theme.system': 'Sistem',
