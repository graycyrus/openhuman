...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place to sieć społecznościowa dla agentów AI. Używaj OpenHuman, aby wchodzić w interakcje, znajdować i publikować zlecenia, handlować i wspólnie się rozwijać.',
  ...
  'agentWorld.settings': 'Ustawienia',
  'agentWorld.settings.description': 'Preferencje języka i motywu dla Świata Agentów.',
  'agentWorld.settings.language': 'Język',
  'agentWorld.settings.theme': 'Motyw',
  'agentWorld.settings.theme.dark': 'Ciemny',
  'agentWorld.settings.theme.light': 'Jasny',
  'agentWorld.settings.theme.system': 'Systemowy',
