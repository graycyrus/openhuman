...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Towarzysz przeglądarki',
  'settings.browserCompanion.menuDesc': 'Sparuj rozszerzenie Chrome, aby udostępniać karty swojemu agentowi przez lokalny przekaźnik',
  'settings.browserCompanion.loading': 'Wczytywanie stanu Towarzysza przeglądarki...',
  'settings.browserCompanion.loadError': 'Nie udało się wczytać stanu Towarzysza przeglądarki',
  'settings.browserCompanion.saveError': 'Nie udało się zapisać ustawień Towarzysza przeglądarki',
  'settings.browserCompanion.saving': 'Zapisywanie...',
  'settings.browserCompanion.statusTitle': 'Stan',
  'settings.browserCompanion.relayStatusLabel': 'Przekaźnik',
  'settings.browserCompanion.extensionStatusLabel': 'Rozszerzenie',
  'settings.browserCompanion.running': 'Działa',
  'settings.browserCompanion.stopped': 'Zatrzymany',
  'settings.browserCompanion.extensionConnected': 'Połączone',
  'settings.browserCompanion.extensionDisconnected': 'Niepołączone',
  'settings.browserCompanion.enableLabel': 'Włącz Towarzysza przeglądarki',
  'settings.browserCompanion.enableDesc': 'Uruchom lokalny przekaźnik, aby sparowane rozszerzenie Chrome mogło udostępniać karty Twojemu agentowi',
  'settings.browserCompanion.pairingTitle': 'Parowanie',
  'settings.browserCompanion.pairingDesc': 'Połącz rozszerzenie Chrome, używając adresu URL przekaźnika i tokenu parowania',
  'settings.browserCompanion.relayUrl': 'Adres URL przekaźnika',
  'settings.browserCompanion.copy': 'Kopiuj',
  'settings.browserCompanion.copied': 'Skopiowano!',
  'settings.browserCompanion.pairingSecret': 'Token parowania',
  'settings.browserCompanion.pairingSecretNone': 'Sparuj lub obróć sekret, aby wyświetlić token',
  'settings.browserCompanion.extensionIdLabel': 'ID rozszerzenia',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID rozszerzenia Chrome',
  'settings.browserCompanion.pairButton': 'Paruj',
  'settings.browserCompanion.pairError': 'Nie udało się sparować rozszerzenia',
  'settings.browserCompanion.rotateError': 'Nie udało się obrócić sekretu parowania',
  'settings.browserCompanion.unpairError': 'Nie udało się odparować rozszerzenia',
  'settings.browserCompanion.installExtension': 'Zainstaluj rozszerzenie',
  'settings.browserCompanion.installError': 'Nie udało się otworzyć folderu rozszerzenia',
  'settings.browserCompanion.openChromeExtensions': 'Otwórz chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'Instalacja rozszerzenia jest dostępna tylko na komputerze',
  'settings.browserCompanion.sharedTabsTitle': 'Udostępnione karty',
  'settings.browserCompanion.sharedTabsDesc': 'Karty, które sparowane rozszerzenie udostępniło Twojemu agentowi',
  'settings.browserCompanion.noSharedTabs': 'Żadne karty nie zostały jeszcze udostępnione',
  'settings.browserCompanion.dangerZoneTitle': 'Strefa zagrożenia',
  'settings.browserCompanion.rotateSecret': 'Obróć sekret',
  'settings.browserCompanion.rotateConfirm': 'Obrócić sekret parowania? Rozszerzenie będzie musiało sparować się ponownie z nowym tokenem.',
  'settings.browserCompanion.unpair': 'Odparuj',
  'settings.browserCompanion.unpairConfirm': 'Odparować rozszerzenie? Aby połączyć się ponownie, trzeba będzie je sparować od nowa.',
