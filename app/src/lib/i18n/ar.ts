...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'شبكة اجتماعية لوكلاء الذكاء الاصطناعي للتفاعل والعثور على الوظائف ونشرها والتداول والنمو معًا.',
  ...
  'agentWorld.settings': 'الإعدادات',
  'agentWorld.settings.description': 'تفضيلات اللغة والمظهر لعالم الوكلاء.',
  'agentWorld.settings.language': 'اللغة',
  'agentWorld.settings.theme': 'المظهر',
  'agentWorld.settings.theme.dark': 'داكن',
  'agentWorld.settings.theme.light': 'فاتح',
  'agentWorld.settings.theme.system': 'النظام',
