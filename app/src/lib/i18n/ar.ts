...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'مرافق المتصفح',
  'settings.browserCompanion.menuDesc': 'اقرن امتداد Chrome لمشاركة علامات التبويب مع وكيلك عبر تتابع محلي',
  'settings.browserCompanion.loading': 'جارٍ تحميل حالة مرافق المتصفح...',
  'settings.browserCompanion.loadError': 'فشل تحميل حالة مرافق المتصفح',
  'settings.browserCompanion.saveError': 'فشل حفظ إعدادات مرافق المتصفح',
  'settings.browserCompanion.saving': 'جارٍ الحفظ...',
  'settings.browserCompanion.statusTitle': 'الحالة',
  'settings.browserCompanion.relayStatusLabel': 'المُرحِّل',
  'settings.browserCompanion.extensionStatusLabel': 'الامتداد',
  'settings.browserCompanion.running': 'قيد التشغيل',
  'settings.browserCompanion.stopped': 'متوقف',
  'settings.browserCompanion.extensionConnected': 'متصل',
  'settings.browserCompanion.extensionDisconnected': 'غير متصل',
  'settings.browserCompanion.enableLabel': 'تفعيل مرافق المتصفح',
  'settings.browserCompanion.enableDesc': 'ابدأ تتابعًا محليًا حتى يتمكن امتداد Chrome المقترن من مشاركة علامات التبويب مع وكيلك',
  'settings.browserCompanion.pairingTitle': 'الإقران',
  'settings.browserCompanion.pairingDesc': 'وصل امتداد Chrome باستخدام رابط التتابع ورمز الإقران',
  'settings.browserCompanion.relayUrl': 'رابط التتابع',
  'settings.browserCompanion.copy': 'نسخ',
  'settings.browserCompanion.copied': 'تم النسخ!',
  'settings.browserCompanion.pairingSecret': 'رمز الإقران',
  'settings.browserCompanion.pairingSecretNone': 'اقرن أو دوّر الرمز السري لإظهار الرمز',
  'settings.browserCompanion.extensionIdLabel': 'معرّف الامتداد',
  'settings.browserCompanion.extensionIdPlaceholder': 'معرّف امتداد Chrome',
  'settings.browserCompanion.pairButton': 'إقران',
  'settings.browserCompanion.pairError': 'فشل إقران الامتداد',
  'settings.browserCompanion.rotateError': 'فشل تدوير الرمز السري للإقران',
  'settings.browserCompanion.unpairError': 'فشل إلغاء إقران الامتداد',
  'settings.browserCompanion.installExtension': 'تثبيت الامتداد',
  'settings.browserCompanion.installError': 'فشل فتح مجلد الامتداد',
  'settings.browserCompanion.openChromeExtensions': 'فتح chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'تثبيت الامتداد متاح على سطح المكتب فقط',
  'settings.browserCompanion.sharedTabsTitle': 'علامات التبويب المشتركة',
  'settings.browserCompanion.sharedTabsDesc': 'علامات التبويب التي شاركها الامتداد المقترن مع وكيلك',
  'settings.browserCompanion.noSharedTabs': 'لم تتم مشاركة أي علامات تبويب بعد',
  'settings.browserCompanion.dangerZoneTitle': 'منطقة الخطر',
  'settings.browserCompanion.rotateSecret': 'تدوير الرمز السري',
  'settings.browserCompanion.rotateConfirm': 'هل تريد تدوير الرمز السري للإقران؟ سيحتاج الامتداد إلى الإقران مرة أخرى بالرمز الجديد.',
  'settings.browserCompanion.unpair': 'إلغاء الإقران',
  'settings.browserCompanion.unpairConfirm': 'هل تريد إلغاء إقران الامتداد؟ ستحتاج إلى الإقران مرة أخرى لإعادة الاتصال.',
