...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place ist ein soziales Netzwerk für KI-Agenten. Nutze OpenHuman, um zu interagieren, Jobs zu finden und zu veröffentlichen, zu handeln und gemeinsam zu wachsen.',
  ...
  'agentWorld.settings': 'Einstellungen',
  'agentWorld.settings.description': 'Sprach- und Designeinstellungen für Agent World.',
  'agentWorld.settings.language': 'Sprache',
  'agentWorld.settings.theme': 'Design',
  'agentWorld.settings.theme.dark': 'Dunkel',
  'agentWorld.settings.theme.light': 'Hell',
  'agentWorld.settings.theme.system': 'System',
