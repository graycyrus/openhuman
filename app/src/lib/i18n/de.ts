...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Browser-Begleiter',
  'settings.browserCompanion.menuDesc': 'Verbinde eine Chrome-Erweiterung, um Tabs über ein lokales Relay mit deinem Agenten zu teilen',
  'settings.browserCompanion.loading': 'Status von Browser-Begleiter wird geladen...',
  'settings.browserCompanion.loadError': 'Status von Browser-Begleiter konnte nicht geladen werden',
  'settings.browserCompanion.saveError': 'Einstellungen für Browser-Begleiter konnten nicht gespeichert werden',
  'settings.browserCompanion.saving': 'Wird gespeichert...',
  'settings.browserCompanion.statusTitle': 'Status',
  'settings.browserCompanion.relayStatusLabel': 'Relay',
  'settings.browserCompanion.extensionStatusLabel': 'Erweiterung',
  'settings.browserCompanion.running': 'Aktiv',
  'settings.browserCompanion.stopped': 'Gestoppt',
  'settings.browserCompanion.extensionConnected': 'Verbunden',
  'settings.browserCompanion.extensionDisconnected': 'Nicht verbunden',
  'settings.browserCompanion.enableLabel': 'Browser-Begleiter aktivieren',
  'settings.browserCompanion.enableDesc': 'Starte ein lokales Relay, damit eine verbundene Chrome-Erweiterung Tabs mit deinem Agenten teilen kann',
  'settings.browserCompanion.pairingTitle': 'Kopplung',
  'settings.browserCompanion.pairingDesc': 'Verbinde die Chrome-Erweiterung über die Relay-URL und ein Kopplungs-Token',
  'settings.browserCompanion.relayUrl': 'Relay-URL',
  'settings.browserCompanion.copy': 'Kopieren',
  'settings.browserCompanion.copied': 'Kopiert!',
  'settings.browserCompanion.pairingSecret': 'Kopplungs-Token',
  'settings.browserCompanion.pairingSecretNone': 'Koppeln oder das Geheimnis erneuern, um ein Token anzuzeigen',
  'settings.browserCompanion.extensionIdLabel': 'Erweiterungs-ID',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome-Erweiterungs-ID',
  'settings.browserCompanion.pairButton': 'Koppeln',
  'settings.browserCompanion.pairError': 'Kopplung der Erweiterung fehlgeschlagen',
  'settings.browserCompanion.rotateError': 'Erneuern des Kopplungsgeheimnisses fehlgeschlagen',
  'settings.browserCompanion.unpairError': 'Entkoppeln der Erweiterung fehlgeschlagen',
  'settings.browserCompanion.installExtension': 'Erweiterung installieren',
  'settings.browserCompanion.installError': 'Öffnen des Erweiterungsordners fehlgeschlagen',
  'settings.browserCompanion.openChromeExtensions': 'chrome://extensions öffnen',
  'settings.browserCompanion.desktopOnly': 'Die Installation der Erweiterung ist nur auf dem Desktop verfügbar',
  'settings.browserCompanion.sharedTabsTitle': 'Geteilte Tabs',
  'settings.browserCompanion.sharedTabsDesc': 'Tabs, die die gekoppelte Erweiterung mit deinem Agenten geteilt hat',
  'settings.browserCompanion.noSharedTabs': 'Noch keine Tabs geteilt',
  'settings.browserCompanion.dangerZoneTitle': 'Gefahrenzone',
  'settings.browserCompanion.rotateSecret': 'Geheimnis erneuern',
  'settings.browserCompanion.rotateConfirm': 'Das Kopplungsgeheimnis erneuern? Die Erweiterung muss sich mit dem neuen Token erneut koppeln.',
  'settings.browserCompanion.unpair': 'Entkoppeln',
  'settings.browserCompanion.unpairConfirm': 'Die Erweiterung entkoppeln? Du musst sie erneut koppeln, um die Verbindung wiederherzustellen.',
