...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': '浏览器伴侣',
  'settings.browserCompanion.menuDesc': '配对 Chrome 扩展程序，通过本地中继与您的智能体共享标签页',
  'settings.browserCompanion.loading': '正在加载浏览器伴侣状态...',
  'settings.browserCompanion.loadError': '加载浏览器伴侣状态失败',
  'settings.browserCompanion.saveError': '保存浏览器伴侣设置失败',
  'settings.browserCompanion.saving': '正在保存...',
  'settings.browserCompanion.statusTitle': '状态',
  'settings.browserCompanion.relayStatusLabel': '中继',
  'settings.browserCompanion.extensionStatusLabel': '扩展程序',
  'settings.browserCompanion.running': '运行中',
  'settings.browserCompanion.stopped': '已停止',
  'settings.browserCompanion.extensionConnected': '已连接',
  'settings.browserCompanion.extensionDisconnected': '未连接',
  'settings.browserCompanion.enableLabel': '启用浏览器伴侣',
  'settings.browserCompanion.enableDesc': '启动本地中继，让已配对的 Chrome 扩展程序可以与您的智能体共享标签页',
  'settings.browserCompanion.pairingTitle': '配对',
  'settings.browserCompanion.pairingDesc': '使用中继 URL 和配对令牌连接 Chrome 扩展程序',
  'settings.browserCompanion.relayUrl': '中继 URL',
  'settings.browserCompanion.copy': '复制',
  'settings.browserCompanion.copied': '已复制！',
  'settings.browserCompanion.pairingSecret': '配对令牌',
  'settings.browserCompanion.pairingSecretNone': '配对或轮换密钥以显示令牌',
  'settings.browserCompanion.extensionIdLabel': '扩展程序 ID',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome 扩展程序 ID',
  'settings.browserCompanion.pairButton': '配对',
  'settings.browserCompanion.pairError': '配对扩展程序失败',
  'settings.browserCompanion.rotateError': '轮换配对密钥失败',
  'settings.browserCompanion.unpairError': '取消配对扩展程序失败',
  'settings.browserCompanion.installExtension': '安装扩展程序',
  'settings.browserCompanion.installError': '打开扩展程序文件夹失败',
  'settings.browserCompanion.openChromeExtensions': '打开 chrome://extensions',
  'settings.browserCompanion.desktopOnly': '安装扩展程序仅在桌面端可用',
  'settings.browserCompanion.sharedTabsTitle': '已共享的标签页',
  'settings.browserCompanion.sharedTabsDesc': '已配对的扩展程序与您的智能体共享的标签页',
  'settings.browserCompanion.noSharedTabs': '尚未共享任何标签页',
  'settings.browserCompanion.dangerZoneTitle': '危险区域',
  'settings.browserCompanion.rotateSecret': '轮换密钥',
  'settings.browserCompanion.rotateConfirm': '要轮换配对密钥吗？扩展程序需要使用新令牌重新配对。',
  'settings.browserCompanion.unpair': '取消配对',
  'settings.browserCompanion.unpairConfirm': '要取消配对扩展程序吗？您需要重新配对才能重新连接。',
