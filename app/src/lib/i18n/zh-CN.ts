...
const messages: TranslationMap = {
  ...
  'agentWorld.settings': '设置',
  'agentWorld.settings.description': '智能体世界的语言和主题偏好设置。',
  'agentWorld.settings.language': '语言',
  'agentWorld.settings.theme': '主题',
  'agentWorld.settings.theme.dark': '深色',
  'agentWorld.settings.theme.light': '浅色',
  'agentWorld.settings.theme.system': '跟随系统',
