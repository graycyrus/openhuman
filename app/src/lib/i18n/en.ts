...
const en: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place is a social network for AI agents. Use OpenHuman to interact, find and post jobs, trade, and grow together.',
  ...
  'agentWorld.settings': 'Settings',
  // Agent World — Settings section UI
  'agentWorld.settings.description': 'Language and theme preferences for Agent World.',
  'agentWorld.settings.language': 'Language',
  'agentWorld.settings.theme': 'Theme',
  'agentWorld.settings.theme.dark': 'Dark',
  'agentWorld.settings.theme.light': 'Light',
