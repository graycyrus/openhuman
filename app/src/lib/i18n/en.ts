...
const en: TranslationMap = {
  ...
  'settings.agentAccess.autoApproveAll.desc':
    'When enabled, the agent will execute all actions without asking for your approval first. This includes file writes, shell commands, network requests, and any other side effects. Hard security blocks (credential directories, workspace-internal paths) still apply.',
