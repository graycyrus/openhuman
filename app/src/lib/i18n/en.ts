...
const en: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Browser Companion',
  'settings.browserCompanion.menuDesc':
    'Pair a Chrome extension to share tabs with your agent over a local relay',
  'settings.browserCompanion.loading': 'Loading Browser Companion status...',
  'settings.browserCompanion.loadError': 'Failed to load Browser Companion status',
  'settings.browserCompanion.saveError': 'Failed to save Browser Companion settings',
  'settings.browserCompanion.saving': 'Saving...',
  ...
  'settings.browserCompanion.running': 'Running',
  'settings.browserCompanion.stopped': 'Stopped',
  'settings.browserCompanion.extensionConnected': 'Connected',
  'settings.browserCompanion.extensionDisconnected': 'Not connected',
  'settings.browserCompanion.enableLabel': 'Enable Browser Companion',
  'settings.browserCompanion.enableDesc':
    'Start a local relay so a paired Chrome extension can share tabs with your agent',
  'settings.browserCompanion.pairingTitle': 'Pairing',
  'settings.browserCompanion.pairingDesc':
    'Connect the Chrome extension using the relay URL and a pairing token',
  'settings.browserCompanion.relayUrl': 'Relay URL',
  'settings.browserCompanion.copy': 'Copy',
  'settings.browserCompanion.copied': 'Copied!',
  'settings.browserCompanion.pairingSecret': 'Pairing token',
  'settings.browserCompanion.pairingSecretNone': 'Pair or rotate the secret to reveal a token',
  'settings.browserCompanion.extensionIdLabel': 'Extension ID',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome extension ID',
  'settings.browserCompanion.pairButton': 'Pair',
  'settings.browserCompanion.pairError': 'Failed to pair the extension',
  'settings.browserCompanion.rotateError': 'Failed to rotate the pairing secret',
  'settings.browserCompanion.unpairError': 'Failed to unpair the extension',
  'settings.browserCompanion.installExtension': 'Install extension',
  'settings.browserCompanion.installError': 'Failed to open the extension folder',
  'settings.browserCompanion.openChromeExtensions': 'Open chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'Installing the extension is available on desktop only',
  'settings.browserCompanion.sharedTabsTitle': 'Shared tabs',
  'settings.browserCompanion.sharedTabsDesc': 'Tabs the paired extension has shared with your agent',
  'settings.browserCompanion.noSharedTabs': 'No tabs shared yet',
  'settings.browserCompanion.dangerZoneTitle': 'Danger zone',
  'settings.browserCompanion.rotateSecret': 'Rotate secret',
  'settings.browserCompanion.rotateConfirm':
    'Rotate the pairing secret? The extension will need to pair again with the new token.',
  'settings.browserCompanion.unpair': 'Unpair',
  'settings.browserCompanion.unpairConfirm':
    'Unpair the extension? You will need to pair again to reconnect it.',
