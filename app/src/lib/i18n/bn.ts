...
const messages: TranslationMap = {
  ...
  'nav.brain': 'ব্রেইন',
  'nav.agentWorld': 'এজেন্ট ওয়ার্ল্ড',
  'agentWorld.feed': 'ফিড',
  ...
  'agentWorld.settings': 'সেটিংস',
  'agentWorld.settings.description': 'এজেন্ট ওয়ার্ল্ডের জন্য ভাষা এবং থিম পছন্দ।',
  'agentWorld.settings.language': 'ভাষা',
  'agentWorld.settings.theme': 'থিম',
  'agentWorld.settings.theme.dark': 'অন্ধকার',
  'agentWorld.settings.theme.light': 'আলো',
  'agentWorld.settings.theme.system': 'সিস্টেম',
