...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'ব্রাউজার সঙ্গী',
  'settings.browserCompanion.menuDesc': 'স্থানীয় রিলের মাধ্যমে আপনার এজেন্টের সাথে ট্যাব শেয়ার করতে একটি Chrome এক্সটেনশন পেয়ার করুন',
  'settings.browserCompanion.loading': 'ব্রাউজার সঙ্গীের স্ট্যাটাস লোড হচ্ছে...',
  'settings.browserCompanion.loadError': 'ব্রাউজার সঙ্গীের স্ট্যাটাস লোড করতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.saveError': 'ব্রাউজার সঙ্গীের সেটিংস সংরক্ষণ করতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.saving': 'সংরক্ষণ করা হচ্ছে...',
  'settings.browserCompanion.statusTitle': 'স্ট্যাটাস',
  'settings.browserCompanion.relayStatusLabel': 'রিলে',
  'settings.browserCompanion.extensionStatusLabel': 'এক্সটেনশন',
  'settings.browserCompanion.running': 'চলছে',
  'settings.browserCompanion.stopped': 'বন্ধ আছে',
  'settings.browserCompanion.extensionConnected': 'সংযুক্ত',
  'settings.browserCompanion.extensionDisconnected': 'সংযুক্ত নয়',
  'settings.browserCompanion.enableLabel': 'ব্রাউজার সঙ্গী সক্রিয় করুন',
  'settings.browserCompanion.enableDesc': 'একটি স্থানীয় রিলে শুরু করুন যাতে পেয়ার করা Chrome এক্সটেনশন আপনার এজেন্টের সাথে ট্যাব শেয়ার করতে পারে',
  'settings.browserCompanion.pairingTitle': 'পেয়ারিং',
  'settings.browserCompanion.pairingDesc': 'রিলে URL এবং একটি পেয়ারিং টোকেন ব্যবহার করে Chrome এক্সটেনশন সংযুক্ত করুন',
  'settings.browserCompanion.relayUrl': 'রিলে URL',
  'settings.browserCompanion.copy': 'কপি করুন',
  'settings.browserCompanion.copied': 'কপি হয়েছে!',
  'settings.browserCompanion.pairingSecret': 'পেয়ারিং টোকেন',
  'settings.browserCompanion.pairingSecretNone': 'টোকেন দেখতে পেয়ার করুন বা সিক্রেট পরিবর্তন করুন',
  'settings.browserCompanion.extensionIdLabel': 'এক্সটেনশন আইডি',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome এক্সটেনশন আইডি',
  'settings.browserCompanion.pairButton': 'পেয়ার করুন',
  'settings.browserCompanion.pairError': 'এক্সটেনশন পেয়ার করতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.rotateError': 'পেয়ারিং সিক্রেট পরিবর্তন করতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.unpairError': 'এক্সটেনশন আনপেয়ার করতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.installExtension': 'এক্সটেনশন ইনস্টল করুন',
  'settings.browserCompanion.installError': 'এক্সটেনশন ফোল্ডার খুলতে ব্যর্থ হয়েছে',
  'settings.browserCompanion.openChromeExtensions': 'chrome://extensions খুলুন',
  'settings.browserCompanion.desktopOnly': 'এক্সটেনশন ইনস্টল করা শুধু ডেস্কটপে উপলব্ধ',
  'settings.browserCompanion.sharedTabsTitle': 'শেয়ার করা ট্যাব',
  'settings.browserCompanion.sharedTabsDesc': 'পেয়ার করা এক্সটেনশন আপনার এজেন্টের সাথে যে ট্যাবগুলো শেয়ার করেছে',
  'settings.browserCompanion.noSharedTabs': 'এখনো কোনো ট্যাব শেয়ার করা হয়নি',
  'settings.browserCompanion.dangerZoneTitle': 'বিপদ অঞ্চল',
  'settings.browserCompanion.rotateSecret': 'সিক্রেট পরিবর্তন করুন',
  'settings.browserCompanion.rotateConfirm': 'পেয়ারিং সিক্রেট পরিবর্তন করবেন? এক্সটেনশনটিকে নতুন টোকেন দিয়ে আবার পেয়ার করতে হবে।',
  'settings.browserCompanion.unpair': 'আনপেয়ার করুন',
  'settings.browserCompanion.unpairConfirm': 'এক্সটেনশন আনপেয়ার করবেন? পুনরায় সংযোগ করতে আপনাকে আবার পেয়ার করতে হবে।',
