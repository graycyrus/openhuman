...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Companheiro do navegador',
  'settings.browserCompanion.menuDesc': 'Emparelhe uma extensão do Chrome para compartilhar abas com seu agente por meio de um relay local',
  'settings.browserCompanion.loading': 'Carregando o status do Companheiro do navegador...',
  'settings.browserCompanion.loadError': 'Falha ao carregar o status do Companheiro do navegador',
  'settings.browserCompanion.saveError': 'Falha ao salvar as configurações do Companheiro do navegador',
  'settings.browserCompanion.saving': 'Salvando...',
  'settings.browserCompanion.statusTitle': 'Status',
  'settings.browserCompanion.relayStatusLabel': 'Relay',
  'settings.browserCompanion.extensionStatusLabel': 'Extensão',
  'settings.browserCompanion.running': 'Em execução',
  'settings.browserCompanion.stopped': 'Parado',
  'settings.browserCompanion.extensionConnected': 'Conectada',
  'settings.browserCompanion.extensionDisconnected': 'Não conectada',
  'settings.browserCompanion.enableLabel': 'Ativar o Companheiro do navegador',
  'settings.browserCompanion.enableDesc': 'Inicie um relay local para que uma extensão do Chrome emparelhada possa compartilhar abas com seu agente',
  'settings.browserCompanion.pairingTitle': 'Emparelhamento',
  'settings.browserCompanion.pairingDesc': 'Conecte a extensão do Chrome usando a URL do relay e um token de emparelhamento',
  'settings.browserCompanion.relayUrl': 'URL do relay',
  'settings.browserCompanion.copy': 'Copiar',
  'settings.browserCompanion.copied': 'Copiado!',
  'settings.browserCompanion.pairingSecret': 'Token de emparelhamento',
  'settings.browserCompanion.pairingSecretNone': 'Emparelhe ou gire o segredo para revelar um token',
  'settings.browserCompanion.extensionIdLabel': 'ID da extensão',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID da extensão do Chrome',
  'settings.browserCompanion.pairButton': 'Emparelhar',
  'settings.browserCompanion.pairError': 'Falha ao emparelhar a extensão',
  'settings.browserCompanion.rotateError': 'Falha ao girar o segredo de emparelhamento',
  'settings.browserCompanion.unpairError': 'Falha ao desemparelhar a extensão',
  'settings.browserCompanion.installExtension': 'Instalar extensão',
  'settings.browserCompanion.installError': 'Falha ao abrir a pasta da extensão',
  'settings.browserCompanion.openChromeExtensions': 'Abrir chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'A instalação da extensão está disponível apenas no desktop',
  'settings.browserCompanion.sharedTabsTitle': 'Abas compartilhadas',
  'settings.browserCompanion.sharedTabsDesc': 'Abas que a extensão emparelhada compartilhou com seu agente',
  'settings.browserCompanion.noSharedTabs': 'Nenhuma aba compartilhada ainda',
  'settings.browserCompanion.dangerZoneTitle': 'Zona de perigo',
  'settings.browserCompanion.rotateSecret': 'Girar segredo',
  'settings.browserCompanion.rotateConfirm': 'Girar o segredo de emparelhamento? A extensão precisará ser emparelhada novamente com o novo token.',
  'settings.browserCompanion.unpair': 'Desemparelhar',
  'settings.browserCompanion.unpairConfirm': 'Desemparelhar a extensão? Você precisará emparelhá-la novamente para reconectá-la.',
