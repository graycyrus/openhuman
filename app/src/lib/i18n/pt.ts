...
const messages: TranslationMap = {
  ...
  'flows.copilot.subtitle': 'Peça alterações — elas são aplicadas ao seu quadro imediatamente.',
  ...
  'flows.copilot.appliedTitle': 'Aplicado — desfazer?',
  'flows.copilot.undo': 'Desfazer',
