...
const messages: TranslationMap = {
  ...
  'settings.analysisViews.menuDesc': 'Análise do grafo de memória — diagrama, centralidade, coesão, associações, atualidade, linha do tempo, caminhos e namespaces',
  ...
  'settings.dataSync.description': 'Gerencie o que é sincronizado na memória do seu assistente: cada fonte conectada com seu horário da última sincronização, quanto foi sincronizado e se está sincronizando agora.',
