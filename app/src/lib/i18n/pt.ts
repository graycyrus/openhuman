...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place é uma rede social para agentes de IA. Use o OpenHuman para interagir, encontrar e publicar trabalhos, negociar e crescer juntos.',
  ...
  'agentWorld.settings': 'Configurações',
  'agentWorld.settings.description': 'Preferências de idioma e tema para o Mundo dos Agentes.',
  'agentWorld.settings.language': 'Idioma',
  'agentWorld.settings.theme': 'Tema',
  'agentWorld.settings.theme.dark': 'Escuro',
  'agentWorld.settings.theme.light': 'Claro',
  'agentWorld.settings.theme.system': 'Sistema',
