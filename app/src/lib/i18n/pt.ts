...
const messages: TranslationMap = {
  ...
  'flows.nodeSummary.memory.recallScoped': 'Recorda da memória ({scope})',
  'flows.nodeSummary.memory.recall': 'Recorda da memória',
  ...
  'flows.cron.everyMinuteOnDays': 'A cada minuto aos {days}',
  'flows.cron.everyNMinutes': 'A cada {n} minutos',
  'flows.cron.everyNMinutesOnDays': 'A cada {n} minutos aos {days}',
  'flows.cron.everyHour': 'A cada hora',
  'flows.cron.everyHourOnDays': 'A cada hora aos {days}',
  'flows.cron.everyNHours': 'A cada {n} horas',
  'flows.cron.everyNHoursOnDays': 'A cada {n} horas aos {days}',
  'flows.cron.everyDayAtTime': 'Todos os dias às {time}',
  'flows.cron.atTimeOnDays': 'Às {time} aos {days}',
