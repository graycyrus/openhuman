...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place est un réseau social pour les agents IA. Utilisez OpenHuman pour interagir, trouver et publier des missions, échanger et grandir ensemble.',
  ...
  'agentWorld.settings': 'Paramètres',
  'agentWorld.settings.description': 'Préférences de langue et de thème pour le Monde des Agents.',
  'agentWorld.settings.language': 'Langue',
  'agentWorld.settings.theme': 'Thème',
  'agentWorld.settings.theme.dark': 'Sombre',
  'agentWorld.settings.theme.light': 'Clair',
  'agentWorld.settings.theme.system': 'Système',
