...
const messages: TranslationMap = {
  ...
  'flows.list.exposeToBrowser': "Exposer à l'extension du navigateur",
  'flows.list.exposeToBrowserHint':
    "Permet au panneau latéral de l'extension de navigateur OpenHuman de lister et de déclencher ce workflow.",
  ...
  'settings.browserCompanion.title': 'Compagnon de navigateur',
  'settings.browserCompanion.menuDesc': 'Associez une extension Chrome pour partager des onglets avec votre agent via un relais local',
  'settings.browserCompanion.loading': 'Chargement du statut du Compagnon de navigateur...',
  'settings.browserCompanion.loadError': 'Échec du chargement du statut du Compagnon de navigateur',
  'settings.browserCompanion.saveError': "Échec de l'enregistrement des paramètres du Compagnon de navigateur",
  'settings.browserCompanion.saving': 'Enregistrement...',
  'settings.browserCompanion.statusTitle': 'Statut',
  'settings.browserCompanion.relayStatusLabel': 'Relais',
  'settings.browserCompanion.extensionStatusLabel': 'Extension',
  'settings.browserCompanion.running': "En cours d'exécution",
  'settings.browserCompanion.stopped': 'Arrêté',
  'settings.browserCompanion.extensionConnected': 'Connectée',
  'settings.browserCompanion.extensionDisconnected': 'Non connectée',
  'settings.browserCompanion.enableLabel': 'Activer le Compagnon de navigateur',
  'settings.browserCompanion.enableDesc': "Démarrez un relais local afin qu'une extension Chrome associée puisse partager des onglets avec votre agent",
  'settings.browserCompanion.pairingTitle': 'Association',
  'settings.browserCompanion.pairingDesc': "Connectez l'extension Chrome à l'aide de l'URL du relais et d'un jeton d'association",
  'settings.browserCompanion.relayUrl': 'URL du relais',
  'settings.browserCompanion.copy': 'Copier',
  'settings.browserCompanion.copied': 'Copié !',
  'settings.browserCompanion.pairingSecret': "Jeton d'association",
  'settings.browserCompanion.pairingSecretNone': 'Associez ou régénérez le secret pour révéler un jeton',
  'settings.browserCompanion.extensionIdLabel': "ID de l'extension",
  'settings.browserCompanion.extensionIdPlaceholder': "ID de l'extension Chrome",
  'settings.browserCompanion.pairButton': 'Associer',
  'settings.browserCompanion.pairError': "Échec de l'association de l'extension",
  'settings.browserCompanion.rotateError': "Échec de la régénération du secret d'association",
  'settings.browserCompanion.unpairError': "Échec de la dissociation de l'extension",
  'settings.browserCompanion.installExtension': "Installer l'extension",
  'settings.browserCompanion.installError': "Échec de l'ouverture du dossier de l'extension",
  'settings.browserCompanion.openChromeExtensions': 'Ouvrir chrome://extensions',
  'settings.browserCompanion.desktopOnly': "L'installation de l'extension est disponible uniquement sur le bureau",
  'settings.browserCompanion.sharedTabsTitle': 'Onglets partagés',
  'settings.browserCompanion.sharedTabsDesc': "Onglets que l'extension associée a partagés avec votre agent",
  'settings.browserCompanion.noSharedTabs': 'Aucun onglet partagé pour le moment',
  'settings.browserCompanion.dangerZoneTitle': 'Zone de danger',
  'settings.browserCompanion.rotateSecret': 'Régénérer le secret',
  'settings.browserCompanion.rotateConfirm': "Régénérer le secret d'association ? L'extension devra s'associer à nouveau avec le nouveau jeton.",
  'settings.browserCompanion.unpair': 'Dissocier',
  'settings.browserCompanion.unpairConfirm': "Dissocier l'extension ? Vous devrez l'associer à nouveau pour la reconnecter.",
