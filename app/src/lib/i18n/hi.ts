...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'ब्राउज़र साथी',
  'settings.browserCompanion.menuDesc': 'लोकल रिले के ज़रिए अपने एजेंट के साथ टैब शेयर करने के लिए एक Chrome एक्सटेंशन पेयर करें',
  'settings.browserCompanion.loading': 'ब्राउज़र साथी की स्थिति लोड हो रही है...',
  'settings.browserCompanion.loadError': 'ब्राउज़र साथी की स्थिति लोड करने में विफल',
  'settings.browserCompanion.saveError': 'ब्राउज़र साथी सेटिंग्स सहेजने में विफल',
  'settings.browserCompanion.saving': 'सहेजा जा रहा है...',
  'settings.browserCompanion.statusTitle': 'स्थिति',
  'settings.browserCompanion.relayStatusLabel': 'रिले',
  'settings.browserCompanion.extensionStatusLabel': 'एक्सटेंशन',
  'settings.browserCompanion.running': 'चल रहा है',
  'settings.browserCompanion.stopped': 'रुका हुआ',
  'settings.browserCompanion.extensionConnected': 'कनेक्टेड',
  'settings.browserCompanion.extensionDisconnected': 'कनेक्ट नहीं है',
  'settings.browserCompanion.enableLabel': 'ब्राउज़र साथी सक्षम करें',
  'settings.browserCompanion.enableDesc': 'एक लोकल रिले शुरू करें ताकि पेयर किया गया Chrome एक्सटेंशन आपके एजेंट के साथ टैब शेयर कर सके',
  'settings.browserCompanion.pairingTitle': 'पेयरिंग',
  'settings.browserCompanion.pairingDesc': 'रिले URL और एक पेयरिंग टोकन का उपयोग करके Chrome एक्सटेंशन कनेक्ट करें',
  'settings.browserCompanion.relayUrl': 'रिले URL',
  'settings.browserCompanion.copy': 'कॉपी करें',
  'settings.browserCompanion.copied': 'कॉपी हो गया!',
  'settings.browserCompanion.pairingSecret': 'पेयरिंग टोकन',
  'settings.browserCompanion.pairingSecretNone': 'टोकन देखने के लिए पेयर करें या सीक्रेट को रोटेट करें',
  'settings.browserCompanion.extensionIdLabel': 'एक्सटेंशन ID',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome एक्सटेंशन ID',
  'settings.browserCompanion.pairButton': 'पेयर करें',
  'settings.browserCompanion.pairError': 'एक्सटेंशन पेयर करने में विफल',
  'settings.browserCompanion.rotateError': 'पेयरिंग सीक्रेट रोटेट करने में विफल',
  'settings.browserCompanion.unpairError': 'एक्सटेंशन अनपेयर करने में विफल',
  'settings.browserCompanion.installExtension': 'एक्सटेंशन इंस्टॉल करें',
  'settings.browserCompanion.installError': 'एक्सटेंशन फ़ोल्डर खोलने में विफल',
  'settings.browserCompanion.openChromeExtensions': 'chrome://extensions खोलें',
  'settings.browserCompanion.desktopOnly': 'एक्सटेंशन इंस्टॉल करना केवल डेस्कटॉप पर उपलब्ध है',
  'settings.browserCompanion.sharedTabsTitle': 'शेयर किए गए टैब',
  'settings.browserCompanion.sharedTabsDesc': 'वे टैब जो पेयर किए गए एक्सटेंशन ने आपके एजेंट के साथ शेयर किए हैं',
  'settings.browserCompanion.noSharedTabs': 'अभी तक कोई टैब शेयर नहीं किया गया',
  'settings.browserCompanion.dangerZoneTitle': 'खतरे का क्षेत्र',
  'settings.browserCompanion.rotateSecret': 'सीक्रेट रोटेट करें',
  'settings.browserCompanion.rotateConfirm': 'क्या पेयरिंग सीक्रेट रोटेट करें? एक्सटेंशन को नए टोकन के साथ फिर से पेयर करना होगा।',
  'settings.browserCompanion.unpair': 'अनपेयर करें',
  'settings.browserCompanion.unpairConfirm': 'क्या एक्सटेंशन को अनपेयर करें? दोबारा कनेक्ट करने के लिए आपको फिर से पेयर करना होगा।',
