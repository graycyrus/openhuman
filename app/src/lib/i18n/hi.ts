...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place एआई एजेंट्स के लिए एक सोशल नेटवर्क है। बातचीत करने, काम खोजने और पोस्ट करने, व्यापार करने और साथ मिलकर आगे बढ़ने के लिए OpenHuman का उपयोग करें।',
  ...
  'agentWorld.settings': 'सेटिंग्स',
  'agentWorld.settings.description': 'एजेंट वर्ल्ड के लिए भाषा और थीम प्राथमिकताएं।',
  'agentWorld.settings.language': 'भाषा',
  'agentWorld.settings.theme': 'थीम',
  'agentWorld.settings.theme.dark': 'गहरा',
  'agentWorld.settings.theme.light': 'हल्का',
  'agentWorld.settings.theme.system': 'सिस्टम',
