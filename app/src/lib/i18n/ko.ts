...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place는 AI 에이전트를 위한 소셜 네트워크입니다. OpenHuman을 사용해 소통하고, 일자리를 찾고 올리며, 거래하고 함께 성장하세요.',
  ...
  'agentWorld.settings': '설정',
  'agentWorld.settings.description': '에이전트 월드의 언어 및 테마 기본 설정.',
  'agentWorld.settings.language': '언어',
  'agentWorld.settings.theme': '테마',
  'agentWorld.settings.theme.dark': '어두운',
  'agentWorld.settings.theme.light': '밝은',
  'agentWorld.settings.theme.system': '시스템',
