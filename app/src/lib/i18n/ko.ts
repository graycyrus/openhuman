...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': '브라우저 컴패니언',
  'settings.browserCompanion.menuDesc': '로컬 릴레이를 통해 에이전트와 탭을 공유하도록 Chrome 확장 프로그램을 페어링하세요',
  'settings.browserCompanion.loading': '브라우저 컴패니언 상태를 불러오는 중...',
  'settings.browserCompanion.loadError': '브라우저 컴패니언 상태를 불러오지 못했습니다',
  'settings.browserCompanion.saveError': '브라우저 컴패니언 설정을 저장하지 못했습니다',
  'settings.browserCompanion.saving': '저장 중...',
  'settings.browserCompanion.statusTitle': '상태',
  'settings.browserCompanion.relayStatusLabel': '릴레이',
  'settings.browserCompanion.extensionStatusLabel': '확장 프로그램',
  'settings.browserCompanion.running': '실행 중',
  'settings.browserCompanion.stopped': '중지됨',
  'settings.browserCompanion.extensionConnected': '연결됨',
  'settings.browserCompanion.extensionDisconnected': '연결되지 않음',
  'settings.browserCompanion.enableLabel': '브라우저 컴패니언 활성화',
  'settings.browserCompanion.enableDesc': '페어링된 Chrome 확장 프로그램이 에이전트와 탭을 공유할 수 있도록 로컬 릴레이를 시작합니다',
  'settings.browserCompanion.pairingTitle': '페어링',
  'settings.browserCompanion.pairingDesc': '릴레이 URL과 페어링 토큰을 사용하여 Chrome 확장 프로그램을 연결하세요',
  'settings.browserCompanion.relayUrl': '릴레이 URL',
  'settings.browserCompanion.copy': '복사',
  'settings.browserCompanion.copied': '복사됨!',
  'settings.browserCompanion.pairingSecret': '페어링 토큰',
  'settings.browserCompanion.pairingSecretNone': '토큰을 표시하려면 페어링하거나 시크릿을 교체하세요',
  'settings.browserCompanion.extensionIdLabel': '확장 프로그램 ID',
  'settings.browserCompanion.extensionIdPlaceholder': 'Chrome 확장 프로그램 ID',
  'settings.browserCompanion.pairButton': '페어링',
  'settings.browserCompanion.pairError': '확장 프로그램 페어링에 실패했습니다',
  'settings.browserCompanion.rotateError': '페어링 시크릿 교체에 실패했습니다',
  'settings.browserCompanion.unpairError': '확장 프로그램 페어링 해제에 실패했습니다',
  'settings.browserCompanion.installExtension': '확장 프로그램 설치',
  'settings.browserCompanion.installError': '확장 프로그램 폴더를 여는 데 실패했습니다',
  'settings.browserCompanion.openChromeExtensions': 'chrome://extensions 열기',
  'settings.browserCompanion.desktopOnly': '확장 프로그램 설치는 데스크톱에서만 가능합니다',
  'settings.browserCompanion.sharedTabsTitle': '공유된 탭',
  'settings.browserCompanion.sharedTabsDesc': '페어링된 확장 프로그램이 에이전트와 공유한 탭입니다',
  'settings.browserCompanion.noSharedTabs': '아직 공유된 탭이 없습니다',
  'settings.browserCompanion.dangerZoneTitle': '위험 구역',
  'settings.browserCompanion.rotateSecret': '시크릿 교체',
  'settings.browserCompanion.rotateConfirm': '페어링 시크릿을 교체하시겠습니까? 확장 프로그램은 새 토큰으로 다시 페어링해야 합니다.',
  'settings.browserCompanion.unpair': '페어링 해제',
  'settings.browserCompanion.unpairConfirm': '확장 프로그램의 페어링을 해제하시겠습니까? 다시 연결하려면 다시 페어링해야 합니다.',
