...
const messages: TranslationMap = {
  ...
  'flows.list.exposeToBrowser': 'Exponer a la extensión del navegador',
  'flows.list.exposeToBrowserHint':
    'Permite que el panel lateral de la extensión de navegador de OpenHuman muestre y active este flujo de trabajo.',
  ...
  'settings.browserCompanion.title': 'Compañero del navegador',
  'settings.browserCompanion.menuDesc': 'Vincula una extensión de Chrome para compartir pestañas con tu agente a través de un relé local',
  'settings.browserCompanion.loading': 'Cargando el estado de Compañero del navegador...',
  'settings.browserCompanion.loadError': 'No se pudo cargar el estado de Compañero del navegador',
  'settings.browserCompanion.saveError': 'No se pudo guardar la configuración de Compañero del navegador',
  'settings.browserCompanion.saving': 'Guardando...',
  'settings.browserCompanion.statusTitle': 'Estado',
  'settings.browserCompanion.relayStatusLabel': 'Relé',
  'settings.browserCompanion.extensionStatusLabel': 'Extensión',
  'settings.browserCompanion.running': 'En ejecución',
  'settings.browserCompanion.stopped': 'Detenido',
  'settings.browserCompanion.extensionConnected': 'Conectada',
  'settings.browserCompanion.extensionDisconnected': 'No conectada',
  'settings.browserCompanion.enableLabel': 'Activar Compañero del navegador',
  'settings.browserCompanion.enableDesc': 'Inicia un relé local para que una extensión de Chrome vinculada pueda compartir pestañas con tu agente',
  'settings.browserCompanion.pairingTitle': 'Vinculación',
  'settings.browserCompanion.pairingDesc': 'Conecta la extensión de Chrome usando la URL del relé y un token de vinculación',
  'settings.browserCompanion.relayUrl': 'URL del relé',
  'settings.browserCompanion.copy': 'Copiar',
  'settings.browserCompanion.copied': '¡Copiado!',
  'settings.browserCompanion.pairingSecret': 'Token de vinculación',
  'settings.browserCompanion.pairingSecretNone': 'Vincula o rota el secreto para revelar un token',
  'settings.browserCompanion.extensionIdLabel': 'ID de la extensión',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID de la extensión de Chrome',
  'settings.browserCompanion.pairButton': 'Vincular',
  'settings.browserCompanion.pairError': 'No se pudo vincular la extensión',
  'settings.browserCompanion.rotateError': 'No se pudo rotar el secreto de vinculación',
  'settings.browserCompanion.unpairError': 'No se pudo desvincular la extensión',
  'settings.browserCompanion.installExtension': 'Instalar extensión',
  'settings.browserCompanion.installError': 'No se pudo abrir la carpeta de la extensión',
  'settings.browserCompanion.openChromeExtensions': 'Abrir chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'Instalar la extensión solo está disponible en el escritorio',
  'settings.browserCompanion.sharedTabsTitle': 'Pestañas compartidas',
  'settings.browserCompanion.sharedTabsDesc': 'Pestañas que la extensión vinculada ha compartido con tu agente',
  'settings.browserCompanion.noSharedTabs': 'Todavía no se ha compartido ninguna pestaña',
  'settings.browserCompanion.dangerZoneTitle': 'Zona de peligro',
  'settings.browserCompanion.rotateSecret': 'Rotar secreto',
  'settings.browserCompanion.rotateConfirm': '¿Rotar el secreto de vinculación? La extensión deberá vincularse de nuevo con el nuevo token.',
  'settings.browserCompanion.unpair': 'Desvincular',
  'settings.browserCompanion.unpairConfirm': '¿Desvincular la extensión? Deberás vincularla de nuevo para reconectarla.',
