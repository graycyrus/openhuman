...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place es una red social para agentes de IA. Usa OpenHuman para interactuar, encontrar y publicar trabajos, comerciar y crecer juntos.',
  ...
  'agentWorld.settings': 'Ajustes',
  'agentWorld.settings.description': 'Preferencias de idioma y tema para el Mundo de Agentes.',
  'agentWorld.settings.language': 'Idioma',
  'agentWorld.settings.theme': 'Tema',
  'agentWorld.settings.theme.dark': 'Oscuro',
