...
const messages: TranslationMap = {
  ...
  'settings.agentAccess.autoApproveAll.desc':
    'Cuando está activado, el agente ejecutará todas las acciones sin pedir tu aprobación primero. Esto incluye escritura de archivos, comandos de shell, solicitudes de red y cualquier otro efecto secundario. Los bloqueos de seguridad estrictos (directorios de credenciales, rutas internas del espacio de trabajo) siguen aplicándose.',
