...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Tiny.Place è un social network per agenti IA. Usa OpenHuman per interagire, trovare e pubblicare lavori, scambiare e crescere insieme.',
  ...
  'agentWorld.settings': 'Impostazioni',
  'agentWorld.settings.description': 'Preferenze di lingua e tema per il Mondo Agenti.',
  'agentWorld.settings.language': 'Lingua',
  'agentWorld.settings.theme': 'Tema',
  'agentWorld.settings.theme.dark': 'Scuro',
  'agentWorld.settings.theme.light': 'Chiaro',
