...
const messages: TranslationMap = {
  ...
  'flows.list.exposeToBrowser': "Esponi all'estensione del browser",
  'flows.list.exposeToBrowserHint':
    "Consente al pannello laterale dell'estensione del browser OpenHuman di elencare e avviare questo flusso di lavoro.",
  ...
  'settings.browserCompanion.title': 'Compagno del browser',
  'settings.browserCompanion.menuDesc': "Abbina un'estensione Chrome per condividere schede con il tuo agente tramite un relay locale",
  'settings.browserCompanion.loading': 'Caricamento dello stato di Compagno del browser...',
  'settings.browserCompanion.loadError': 'Impossibile caricare lo stato di Compagno del browser',
  'settings.browserCompanion.saveError': 'Impossibile salvare le impostazioni di Compagno del browser',
  'settings.browserCompanion.saving': 'Salvataggio...',
  'settings.browserCompanion.statusTitle': 'Stato',
  'settings.browserCompanion.relayStatusLabel': 'Relay',
  'settings.browserCompanion.extensionStatusLabel': 'Estensione',
  'settings.browserCompanion.running': 'In esecuzione',
  'settings.browserCompanion.stopped': 'Interrotto',
  'settings.browserCompanion.extensionConnected': 'Connessa',
  'settings.browserCompanion.extensionDisconnected': 'Non connessa',
  'settings.browserCompanion.enableLabel': 'Attiva Compagno del browser',
  'settings.browserCompanion.enableDesc': "Avvia un relay locale in modo che un'estensione Chrome abbinata possa condividere schede con il tuo agente",
  'settings.browserCompanion.pairingTitle': 'Abbinamento',
  'settings.browserCompanion.pairingDesc': "Collega l'estensione Chrome usando l'URL del relay e un token di abbinamento",
  'settings.browserCompanion.relayUrl': 'URL del relay',
  'settings.browserCompanion.copy': 'Copia',
  'settings.browserCompanion.copied': 'Copiato!',
  'settings.browserCompanion.pairingSecret': 'Token di abbinamento',
  'settings.browserCompanion.pairingSecretNone': 'Abbina o ruota il secret per rivelare un token',
  'settings.browserCompanion.extensionIdLabel': 'ID estensione',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID estensione Chrome',
  'settings.browserCompanion.pairButton': 'Abbina',
  'settings.browserCompanion.pairError': "Impossibile abbinare l'estensione",
  'settings.browserCompanion.rotateError': 'Impossibile ruotare il secret di abbinamento',
  'settings.browserCompanion.unpairError': "Impossibile disabbinare l'estensione",
  'settings.browserCompanion.installExtension': 'Installa estensione',
  'settings.browserCompanion.installError': "Impossibile aprire la cartella dell'estensione",
  'settings.browserCompanion.openChromeExtensions': 'Apri chrome://extensions',
  'settings.browserCompanion.desktopOnly': "L'installazione dell'estensione è disponibile solo su desktop",
  'settings.browserCompanion.sharedTabsTitle': 'Schede condivise',
  'settings.browserCompanion.sharedTabsDesc': "Schede che l'estensione abbinata ha condiviso con il tuo agente",
  'settings.browserCompanion.noSharedTabs': 'Nessuna scheda condivisa ancora',
  'settings.browserCompanion.dangerZoneTitle': 'Zona pericolosa',
  'settings.browserCompanion.rotateSecret': 'Ruota secret',
  'settings.browserCompanion.rotateConfirm': "Ruotare il secret di abbinamento? L'estensione dovrà abbinarsi di nuovo con il nuovo token.",
  'settings.browserCompanion.unpair': 'Disabbina',
  'settings.browserCompanion.unpairConfirm': "Disabbinare l'estensione? Dovrai abbinarla di nuovo per riconnetterla.",
