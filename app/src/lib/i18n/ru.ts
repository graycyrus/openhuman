...
const messages: TranslationMap = {
  ...
  'settings.browserCompanion.title': 'Браузерный компаньон',
  'settings.browserCompanion.menuDesc': 'Подключите расширение Chrome, чтобы делиться вкладками с агентом через локальный релей',
  'settings.browserCompanion.loading': 'Загрузка статуса браузерного компаньона...',
  'settings.browserCompanion.loadError': 'Не удалось загрузить статус браузерного компаньона',
  'settings.browserCompanion.saveError': 'Не удалось сохранить настройки браузерного компаньона',
  'settings.browserCompanion.saving': 'Сохранение...',
  'settings.browserCompanion.statusTitle': 'Статус',
  'settings.browserCompanion.relayStatusLabel': 'Релей',
  'settings.browserCompanion.extensionStatusLabel': 'Расширение',
  'settings.browserCompanion.running': 'Работает',
  'settings.browserCompanion.stopped': 'Остановлен',
  'settings.browserCompanion.extensionConnected': 'Подключено',
  'settings.browserCompanion.extensionDisconnected': 'Не подключено',
  'settings.browserCompanion.enableLabel': 'Включить браузерного компаньона',
  'settings.browserCompanion.enableDesc': 'Запустите локальный релей, чтобы подключённое расширение Chrome могло делиться вкладками с вашим агентом',
  'settings.browserCompanion.pairingTitle': 'Подключение',
  'settings.browserCompanion.pairingDesc': 'Подключите расширение Chrome с помощью URL-адреса релея и токена подключения',
  'settings.browserCompanion.relayUrl': 'URL-адрес релея',
  'settings.browserCompanion.copy': 'Копировать',
  'settings.browserCompanion.copied': 'Скопировано!',
  'settings.browserCompanion.pairingSecret': 'Токен подключения',
  'settings.browserCompanion.pairingSecretNone': 'Подключитесь или обновите секрет, чтобы увидеть токен',
  'settings.browserCompanion.extensionIdLabel': 'ID расширения',
  'settings.browserCompanion.extensionIdPlaceholder': 'ID расширения Chrome',
  'settings.browserCompanion.pairButton': 'Подключить',
  'settings.browserCompanion.pairError': 'Не удалось подключить расширение',
  'settings.browserCompanion.rotateError': 'Не удалось обновить секрет подключения',
  'settings.browserCompanion.unpairError': 'Не удалось отключить расширение',
  'settings.browserCompanion.installExtension': 'Установить расширение',
  'settings.browserCompanion.installError': 'Не удалось открыть папку расширения',
  'settings.browserCompanion.openChromeExtensions': 'Открыть chrome://extensions',
  'settings.browserCompanion.desktopOnly': 'Установка расширения доступна только на компьютере',
  'settings.browserCompanion.sharedTabsTitle': 'Общие вкладки',
  'settings.browserCompanion.sharedTabsDesc': 'Вкладки, которыми подключённое расширение поделилось с вашим агентом',
  'settings.browserCompanion.noSharedTabs': 'Пока нет общих вкладок',
  'settings.browserCompanion.dangerZoneTitle': 'Опасная зона',
  'settings.browserCompanion.rotateSecret': 'Обновить секрет',
  'settings.browserCompanion.rotateConfirm': 'Обновить секрет подключения? Расширению потребуется подключиться заново с новым токеном.',
  'settings.browserCompanion.unpair': 'Отключить',
  'settings.browserCompanion.unpairConfirm': 'Отключить расширение? Чтобы восстановить соединение, потребуется подключить его заново.',
