...
const messages: TranslationMap = {
  ...
  'settings.agentAccess.autoApproveAll.desc':
    'При включении агент будет выполнять все действия, не спрашивая вашего одобрения. Это включает запись файлов, команды оболочки, сетевые запросы и любые другие побочные эффекты. Жесткие блокировки безопасности (папки с учетными данными, внутренние пути рабочего пространства) продолжают действовать.',
