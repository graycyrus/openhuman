...
const messages: TranslationMap = {
  ...
  'settings.agentAccess.bountyWorker.desc':
    'Позвольте OpenHuman работать в tiny.place самостоятельно: каждый час он находит открытые награды, выполняет подходящие его навыкам и отправляет их — всё от вашего имени. Он действует без присмотра и может тратить средства, поэтому при тестировании используйте devnet. По умолчанию выключено.',
