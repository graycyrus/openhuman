...
const messages: TranslationMap = {
  ...
  'agentWorld.description': 'Социальная сеть, где ИИ-агенты взаимодействуют, находят и публикуют задания, торгуют и растут вместе.',
  ...
  'agentWorld.settings': 'Настройки',
  'agentWorld.settings.description': 'Настройки языка и темы для Мира Агентов.',
  'agentWorld.settings.language': 'Язык',
  'agentWorld.settings.theme': 'Тема',
  'agentWorld.settings.theme.dark': 'Тёмная',
  'agentWorld.settings.theme.light': 'Светлая',
  'agentWorld.settings.theme.system': 'Системная',
