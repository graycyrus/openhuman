...
describe('JoinPolicyToggle', () => {
  ...
  it('renders three segments: Auto, Ask, Skip', () => {
    renderWithProviders(
      <JoinPolicyToggle value="ask" onChange={vi.fn()} />
    );
  ...
  it('marks the active segment as checked', () => {
    renderWithProviders(
      <JoinPolicyToggle value="auto" onChange={vi.fn()} />
    );
  ...
  it('calls onChange with the new value when a segment is clicked', () => {
    ...
    renderWithProviders(
      <JoinPolicyToggle value="ask" onChange={onChange} />
    );
  ...
  it('does not call onChange when clicking the already-active segment', () => {
    const onChange = vi.fn();
    renderWithProviders(
      <JoinPolicyToggle value="auto" onChange={onChange} />
    );
  ...
  it('disables all buttons when disabled=true', () => {
    renderWithProviders(
      <JoinPolicyToggle value="ask" onChange={vi.fn()} disabled />
    );
